...
TUTORIAL_ROOT = dirname(HERE)
TEMP_LOCATION = '/tmp/tutorial-doc'
...
def main():
    ...
    try:
        ...
        with removing(TEMP_LOCATION):
            ...
            print("Moving to '%s'" % TUTORIAL_ROOT)
    ...
    print()
    print("Updated documentation branch in directory %s" % TUTORIAL_ROOT)
