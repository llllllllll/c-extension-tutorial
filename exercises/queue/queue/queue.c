...
{
    /* repr which looks like '<queue.Queue: 4>' with 4 elements in the queue */
...
static PyObject*
queue_pop(queue* self, PyObject* args, PyObject* kwargs)
{
...
PyMethodDef queue_methods[] = {
    ...
    {"pop", (PyCFunction) queue_pop, METH_VARARGS | METH_KEYWORDS, NULL},
    {NULL},
};
